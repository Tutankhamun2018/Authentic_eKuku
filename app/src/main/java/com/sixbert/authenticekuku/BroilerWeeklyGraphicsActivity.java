...
public class BroilerWeeklyGraphicsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_broiler_weekly_graphics);
        ...
        viewGraph.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (district.trim().isEmpty()) {
                    Toast.makeText(BroilerWeeklyGraphicsActivity.this, "Chagua mji au wilaya husika", Toast.LENGTH_SHORT).show();
                } else {
