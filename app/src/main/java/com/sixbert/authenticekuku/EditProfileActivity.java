...
public class EditProfileActivity extends AppCompatActivity {
    ...
    String storagepath = "Profile_photo/";
    String uid;
    ImageView set;
    TextView profilepic, editname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = databaseReference.orderByChild("phoneNumber").equalTo(uid);
   ...
   /* private void updatePassword(String oldp, final String newp) {
    ...
    private void pickFromCamera() {
        ...
        registerForActivityResult(camerIntent, IMAGE_PICKCAMERA_REQUEST);
    }

    private void registerForActivityResult(Intent camerIntent, int imagePickcameraRequest) {
    }
    ...
    private void pickFromGallery() {
        ...
        registerForActivityResult(galleryIntent, IMAGEPICK_GALLERY_REQUEST);
    }
