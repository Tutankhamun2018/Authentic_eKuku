...
public class BroilerDailyGraphicsActivity extends AppCompatActivity {
        ...
        viewGraph.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (district.trim().isEmpty()) {
                    Toast.makeText(BroilerDailyGraphicsActivity.this, "Chagua mji au wilaya husika", Toast.LENGTH_SHORT).show();
                } else {
