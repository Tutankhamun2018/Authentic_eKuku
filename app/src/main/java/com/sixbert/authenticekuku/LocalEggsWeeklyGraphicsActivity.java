...
public class LocalEggsWeeklyGraphicsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_local_eggs_weekly_graphics);
        ...
        viewGraph.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (district.trim().isEmpty()) {
                    Toast.makeText(LocalEggsWeeklyGraphicsActivity.this, "Chagua mji au wilaya husika", Toast.LENGTH_SHORT).show();
                } else {
